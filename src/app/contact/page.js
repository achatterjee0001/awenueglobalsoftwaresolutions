...
export default function ContactPage() {
  ...
  return (
    <div className="contact-page-redesign">
      ...
      {/* 1. HERO SECTION */}
      <section className="section contact-hero" style={{ minHeight: '75vh', paddingTop: '120px', paddingBottom: '64px', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
