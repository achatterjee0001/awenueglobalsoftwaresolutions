...
export default function ContactPage() {
  ...
  return (
    <div className="contact-page-redesign">
      ...
      {/* 1. HERO SECTION */}
      <section className="section contact-hero" style={{ minHeight: '48vh', paddingTop: '130px', paddingBottom: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
